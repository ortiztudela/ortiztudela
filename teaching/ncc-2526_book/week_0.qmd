...
We will give you a set of broad topics for you to choose from but you will also be able (and encouraged!) to work on a different topic that you find more interesting. If you want to have a more concrete idea of what we are expecting from you, here you can find a selection of the episodes that were created in the previous editions.
...
Find here the full set of podcasts (shared with permission form the authors): https://github.com/ortiztudela/cogneuro/tree/main/podcasts
